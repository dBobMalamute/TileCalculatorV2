...
void CorkboardHandler::LoadPlugins()
{
    ...
    loadPlugin(new TileCalculatorPlugin());
}
...
const QStringList CorkboardHandler::collectionIdeaList(const QString collectionName) const
{
    return m_ideasInCollectionMap.at(collectionName);
}
