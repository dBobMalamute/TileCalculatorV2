...
Rectangle
{
    ...
    SequentialAnimation
    {
        ...
        ParallelAnimation
        {
            PropertyAnimation{target: root; property: "color"; to: finalColor; duration: 2000}
            PropertyAnimation{target: root; property: "border.color"; to: Qt.darker(finalColor); duration: 2000}
        }
    }
