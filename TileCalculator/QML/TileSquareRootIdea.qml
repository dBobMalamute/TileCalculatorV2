...
import "SquareRootHelperFunctions.js" as HelperFunctions
...
Item
{
    ...
    Connections
    {
        ...
        function onDisplay(inputNumber1, outputNumber)
        {
            ...
            if(inputNumber1 < 1 || inputNumber1 > 10000)
            {
            ...
            else
            {
                ...
                HelperFunctions.createBoxes(inputNumber1, outputNumber)
            }
        }
        function onClear()
        {
